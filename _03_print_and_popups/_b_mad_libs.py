...
if __name__ == '__main__':
    ...
    messagebox.showinfo(title='Madlibs', message= 'If you find yourself having to corss a piranha-infested river, here is how to do it.')
    # "If you find yourself having to cross a piranha-infested river, here's how to do it..."

    # Get the player to enter an adjective
    adjective=simpledialog.askstring(title='Madlibs', prompt='Enter adjective')
    # Get the player to enter a type of liquid
    liquid=simpledialog.askstring(title='liquid', prompt='Enter a type of liquid')
    # Get the player to enter a body part
    bodypart=simpledialog.askstring(title='body part', prompt='Enter a body part')
